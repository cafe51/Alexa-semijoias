...
export default function ButtonGoogleLogin({ isGoogleLoading, signInWithGoogle }: ButtonGoogleLoginProps) {
    return (
        <Button
            ...
            className="w-full text-lg bg-white hover:bg-gray-50 text-gray-900 font-semibold py-6 px-4 border border-gray-300 rounded-md shadow-sm flex items-center justify-center space-x-2 transition-all duration-300"
        >
