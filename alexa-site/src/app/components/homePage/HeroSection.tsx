...
export default function HeroSection({ lastAddProduct }: HeroSectionProps) {
    ...
    return (
        <section className="w-full grid md:grid-cols-2 overflow-hidden">
            ...
            <div className="relative aspect-square sm:aspect-[10/7] md:aspect-[3/5] lg:aspect-[4/5] xl:aspect-[5/4] bg-[#C48B9F] p-2 md:p-6">
                <div className="relative flex flex-col items-center justify-center gap-4 h-full w-full box-border border-4 border-[#F8C3D3] border-double ">
                    <h3 className="text-white text-lg uppercase tracking-widest">
