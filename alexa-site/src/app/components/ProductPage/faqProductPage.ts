export const faqProductPage: { question: string; answer: string }[] = [
    ...
    // },
    {
        ...
        answer:
      'Na Alexa Semijoias, a qualidade dos nossos acessórios femininos é prioridade. Por isso, todos os nossos brincos, colares, pulseiras, anéis, tornozeleiras, chokers, argolas, braceletes e conjuntos de semijoia contam com uma garantia de 1 (um) ano para o banho de ouro 18k, a partir da data da compra. Essa garantia cobre defeitos relacionados ao banho de ouro, assegurando que cada semijoia mantenha seu brilho e acabamento sofisticado. Vale lembrar que, em casos de mau uso – como o contato com substâncias abrasivas, cosméticos, perfumes, cloro ou água do mar – a garantia pode ser invalidada.',
    },
    {
    ...
    },
    {
        ...
        answer:
      'A Alexa Semijoias é uma marca 100% digital, especializada em semijoias e acessórios femininos. Não possuímos loja física; todas as nossas vendas de brincos, colares, pulseiras, anéis, tornozeleiras, chokers, argolas, braceletes e conjuntos de semijoia são realizadas através do nosso site. Trabalhamos com entrega em todo o território brasileiro, facilitando a compra do seu presente ou acessório feminino com banho de ouro 18k e acabamento refinado.',
    },
    // {
    //     question: 'Como faço para acionar a garantia?',
    //     answer:
    //   'Para acionar a garantia das semijoias da Alexa Semijoias, entre em contato conosco pelos nossos canais digitais. Você pode enviar uma mensagem via Whatsapp para o número (17) 98165-0632 ou entrar em contato pelo e-mail contato@alexasemijoias.com.br. Esses canais garantem agilidade e registro completo da sua solicitação, seja para um brinco, colar, pulseira, anel, tornozeleira, choker, argola, bracelete ou conjunto de semijoia, mantendo a excelência do banho de ouro 18k e a qualidade dos acessórios femininos que são o presente perfeito para qualquer ocasião.',
    // },
    // {
    //     question: 'Comprei o produto, não gostei ou me arrependi, posso devolver?',
    //     answer:
    //   'Se você adquiriu um brinco, colar, pulseira, anel, tornozeleira, choker, argola, bracelete ou qualquer conjunto de semijoia da Alexa Semijoia e não ficou satisfeito ou se arrependeu da compra, é possível realizar a devolução. Basta entrar em contato conosco pelo Whatsapp (17) 98165-0632 ou pelo e-mail contato@alexasemijoias.com.br dentro de 7 (sete) dias após o recebimento. Essa política se aplica a todos os nossos acessórios femininos de ouro 18k e banho de ouro, garantindo que você receba o presente ideal e com a qualidade esperada. Mesmo após esse prazo, caso surja alguma dúvida ou problema com o brinco, colar, pulseira, anel, tornozeleira, choker, argola, bracelete ou conjunto de semijoia, entre em contato para receber todo o suporte necessário.',
    // },
    // {
    //     question: 'Qual o prazo de aprovação do meu pedido?',
    //     answer:
    //   'O prazo de aprovação do seu pedido de semijoias varia de acordo com a forma de pagamento escolhida. Se o pagamento for efetuado via PIX, a aprovação dos seus acessórios femininos – sejam brincos, colares, pulseiras, anéis, tornozeleiras, chokers, argolas ou braceletes – ocorre em até 24 horas. Já o pagamento via Cartão de Crédito costuma ser aprovado em algumas horas, podendo levar até 2 dias úteis, especialmente quando o meio de pagamento solicita uma análise mais detalhada dos dados cadastrais dos seus produtos de banho de ouro e ouro 18k.',
    // },
    // {
    //     question: 'Posso alterar meu pedido após ter finalizado o pagamento?',
    //     answer:
    ...
    //     answer:
    //   'Alterar o endereço de envio de suas semijoias pode ser um desafio, pois o processamento dos nossos brincos, colares, pulseiras, anéis, tornozeleiras, chokers, argolas, braceletes ou conjunto de semijoia é realizado de forma ágil. Se o seu pedido de presente ou acessório feminino já estiver a caminho com o banho de ouro 18k, entre em contato imediatamente com nossa Central de Atendimento para tentar realizar a alteração. Estamos prontos para oferecer suporte e orientar sobre as possibilidades de ajuste, sempre visando a entrega segura dos seus produtos de alta qualidade.',
    // },
];
