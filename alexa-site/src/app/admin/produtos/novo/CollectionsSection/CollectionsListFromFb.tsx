...
interface CollectionsListFromFbProps {
...
export default function CollectionsListFromFb({ options, selectedOptions, handleCheckboxChange, handlers }: CollectionsListFromFbProps) {
